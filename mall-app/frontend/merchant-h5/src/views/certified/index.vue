<template>
  <div class="verify-content">
    ...
    <div class="submit-content">
      <van-button type="primary" :loading="submitLoading" @click="submitHandle">{{ t('confirm') }}</van-button>
    </div>
  </div>
</template>
...
import { checkEmailOrPhone } from '@/service/user.api'
...
const submitHandle = async () => {
  ...
  checkEmailOrPhone(params).then(async res => {
