  ...
  <div v-show="value" class="vue-image-crop-upload">
    <div class="vicp-wrap">
      ...
      <div v-show="step == 1" class="vicp-step1">
        <div class="vicp-drop-area" @click="handleClick" @dragenter="preventDefault" @dragleave="preventDefault"
             @dragover="preventDefault" @drop="handleChange">
        ...
        <div class="vicp-crop">
          <div v-show="true" class="vicp-crop-left">
            <div class="vicp-img-container">
              <img ref="img" :src="sourceImgUrl" :style="sourceImgStyle" class="vicp-img" draggable="false"
                   @drag="preventDefault" @dragend="preventDefault" @dragenter="preventDefault"
                   @dragleave="preventDefault" @dragover="preventDefault" @dragstart="preventDefault"
                   @drop="preventDefault" @mousedown="imgStartMove" @mousemove="imgMove" @mouseout="createImg"
                   @mouseup="createImg" @touchcancel="createImg" @touchend="createImg" @touchmove="imgMove"
            ...
            <div class="vicp-range">
              <input :value="scale.range" max="100" min="0" step="1" type="range" @input="zoomChange"/>
