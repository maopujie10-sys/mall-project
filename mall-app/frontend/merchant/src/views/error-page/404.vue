<template>
  <div class="wscn-http404-container">
    <div class="wscn-http404">
      ...
      <div class="bullshit">
        <div class="bullshit__oops">{{ $t('OOPS') }}!</div>
        <div class="bullshit__info">{{ $t('All') }} rights reserved

          <a href="https://wallstreetcn.com" style="color:#20a0ff" target="_blank">wallstreetcn</a>

        </div>
        <div class="bullshit__headline">{{ message }}</div>
        <div class="bullshit__info">{{ $t('Please') }} check that the URL you entered is correct, or click the button
          below to
          return to the homepage.
        </div>
        <a class="bullshit__return-home" href="">{{ $t('Back') }} to{{ $t('home') }}</a>
      </div>
    </div>
  </div>
</template>
