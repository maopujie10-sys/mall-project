<template>
  <div class="errPage-container">
    <ErrorA/>
    <ErrorB/>
    <h3>{{ $t('Please') }} click the bug icon in the upper right{{ $t('corner') }}</h3>
    <aside>
      ...
      <a class="link-type" href="https://panjiachen.github.io/vue-element-admin-site/guide/advanced/error.html"
         target="_blank">{{
          $t('Document')
        }}{{ $t('introduction') }}</a>
    </aside>
