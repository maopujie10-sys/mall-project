### [增强] 1234：向量记忆+AI对话串联 / RAG喂知识 / 微信告警 / 预置工作流
- 'agent_chat.py': 向量记忆+RAG知识注入AI对话，每次问答自动检索历史记忆和知识库，回答后自动保存到向量记忆
- 'workflow_engine.py': 新增5个工作流模板(多语言发布/服务器急救/智能定价/商品上架/电话告警)
- 'phone_alert.py': 新增WeChatAlert微信告警渠道(企业微信/ServerChan双通道)
- 'order_alert_router.py': 订单异常预警自动发微信通知
