...
// 个性化返回错误提示信息接口
const diyUrlData = ['/api/seller/goods/update', '/api/seller/goods/save', '/api/cms/']

// 活动接口个性化未登录
const diyLogoutData = ['/api/activity/lottery/points', '/api/activity/lottery/draw', '/api/activity/lottery/my-prizes']
