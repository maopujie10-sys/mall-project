  ...
  <div class="page-container db-panel">
    ...
    <div v-if="activeDb" class="db-workspace">
      <div class="workspace-header">
        ...
        <el-button type="primary" size="small" @click="showSqlEditor=!showSqlEditor">SQL</el-button>
        <el-button size="small" @click="refreshTables">OK</el-button>
      </div>
    ...
    <el-dialog v-model="showSqlEditor" title="SQL " width="700px">
      <el-input v-model="sqlQuery" type="textarea" :rows="6" placeholder="SELECT * FROM ..." />
      <el-button type="primary" @click="runSql" :loading="sqlRunning" style="margin-top:12px"></el-button>
...
const tables = ref([])
const dbStatus = ref({ connected: false, size: '', tables: 0 })
...
async function fetchDBStatus() {
  ...
  try {
    ...
    dbStatus.value = { connected: s.connected || false, size: s.size || '', tables: s.table_count || 0 }
