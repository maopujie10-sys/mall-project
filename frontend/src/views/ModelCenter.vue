<template>
  <div class="page-container model-center">
    ...
    <el-row :gutter="16" style="margin-bottom:20px">
      ...
      <el-col :span="6">
        <div class="metric-card"><div class="metric-label">本月消费</div><div class="metric-value" style="color:#faad14">{{ stats.monthlyCost }}</div><div class="metric-sub">剩余额度 {{ stats.remaining }}</div></div>
      </el-col>
    </el-row>
...
const providers = ['DeepSeek', 'OpenAI', 'Anthropic', 'Google', 'Ollama', 'OpenRouter', 'Local']
const models = ref([])
const stats = reactive({ todayCalls: 0, successRate: 0, monthlyCost: '$ 0', remaining: '$ 0' })

const modes = [
  { id:'quality', name:'高质量', desc:'优先使用最强模型，确保输出质量' },
  { id:'balanced', name:'均衡', desc:'速度与质量兼顾，推荐日常使用' },
  { id:'fast', name:'超高速', desc:'追求最快响应，适合简单任务' },
  { id:'economy', name:'省钱', desc:'使用最具性价比的模型' },
]
