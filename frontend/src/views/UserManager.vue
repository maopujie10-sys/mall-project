...
<el-input v-model="newUser" placeholder='' style="margin-bottom:8px"/>
<el-input v-model="newPass" placeholder='' type="password" style="margin-bottom:8px"/>
<el-select v-model="newRole" placeholder=''><el-option label='' value="admin"/><el-option label='' value="operator"/><el-option label='' value="viewer"/></el-select>
