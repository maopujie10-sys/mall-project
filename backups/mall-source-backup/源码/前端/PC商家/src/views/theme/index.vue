<template>
  <div class="app-container">
    <el-card class="box-card">
      ...
      <div class="box-item">
        <span class="field-label">{{ $t('Change') }} Theme : </span>
    ...
    <div class="block">
      ...
      <el-button type="primary">{{ $t('Upload') }} <i class="el-icon-upload el-icon-right"/></el-button>
    </div>
    ...
    <div class="block">
      <el-radio-group v-model="radio">
        <el-radio :label="3">{{ $t('Option') }}{{ $t('A') }}</el-radio>
        <el-radio :label="6">{{ $t('Option') }}{{ $t('B') }}</el-radio>
        <el-radio :label="9">{{ $t('Option') }}{{ $t('C') }}</el-radio>
      </el-radio-group>
    </div>
