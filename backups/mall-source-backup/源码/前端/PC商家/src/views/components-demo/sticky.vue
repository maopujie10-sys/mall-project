  ...
  <div>
    <sticky :z-index="10" class-name="sub-navbar">
      <el-dropdown trigger="click">
        <el-button plain>{{ $t('Platform') }}<i class="el-icon-caret-bottom el-icon--right"/></el-button>
      ...
      <el-dropdown trigger="click">
        <el-button plain>{{ $t('Link') }}<i class="el-icon-caret-bottom el-icon--right"/></el-button>
    ...
    <div class="components-container">
      <aside>{{ $t('Sticky') }} header, When the page is scrolled to the preset position will be sticky on the top.
      </aside>
      <div>placeholder</div>
      <div>placeholder</div>
      <div>placeholder</div>
