<template>
  <div class="components-container">
    <aside>{{ $t('Markdown') }} is based on

      <a href="https://github.com/nhnent/tui.editor" target="_blank">{{ $t('tui') }}.editor</a>
      ，simply wrapped with Vue.

      <a href="https://panjiachen.github.io/vue-element-admin-site/feature/component/markdown-editor.html"
         target="_blank">
        Documentation </a>
