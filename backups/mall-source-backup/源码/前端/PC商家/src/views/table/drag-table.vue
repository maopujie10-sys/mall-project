<template>
  <div class="app-container">
    ...
    <el-table ref="dragTable" v-loading="listLoading" :data="list" border fit highlight-current-row row-key="id"
              style="width: 100%">
    ...
    <div class="show-d">
      <el-tag>{{ $t('The') }} default order :</el-tag>
      {{ oldList }}
    </div>
    <div class="show-d">
      <el-tag>{{ $t('The') }} after dragging order :</el-tag>
      {{ newList }}
    </div>
  </div>
</template>
