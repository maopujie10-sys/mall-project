<template>
  <div class="app-container">
    <el-button type="primary" @click="handleAddRole">{{ $t('New') }}{{ $t('Role') }}</el-button>
    ...
    <el-dialog :title="dialogType==='edit'?'Edit Role':'New Role'" :visible.sync="dialogVisible">
      <el-form :model="role" label-position="left" label-width="80px">
        ...
        <el-form-item label="Desc">
          <el-input v-model="role.description" :autosize="{ minRows: 2, maxRows: 4}" placeholder="Role Description"
                    type="textarea"/>
        </el-form-item>
