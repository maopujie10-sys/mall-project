...
<div class="ifr-dody">
	...
	<div class="ifr-con">
		<ul class="nav nav-tabs">
			<li><a href="<%=basePath%>/mall/goods/toUpdate.action?lang=en&goodsId=${goodsId}">英文</a></li>
			<li><a href="<%=basePath%>/mall/goods/toUpdate.action?lang=vi&goodsId=${goodsId}">越南语</a></li>
			<li><a href="<%=basePath%>/mall/goods/toUpdate.action?lang=hi&goodsId=${goodsId}">印度语</a></li>
			<li><a href="<%=basePath%>/mall/goods/toUpdate.action?lang=id&goodsId=${goodsId}">印度尼西亚语</a></li>
			<li><a href="<%=basePath%>/mall/goods/toUpdate.action?lang=de&goodsId=${goodsId}">德语</a></li>
			<li><a href="<%=basePath%>/mall/goods/toUpdate.action?lang=fr&goodsId=${goodsId}">法语</a></li>
			<li><a href="<%=basePath%>/mall/goods/toUpdate.action?lang=ru&goodsId=${goodsId}">俄语</a></li>
			<li><a href="<%=basePath%>/mall/goods/toUpdate.action?lang=es&goodsId=${goodsId}">西班牙语</a></li>
			<li><a href="<%=basePath%>/mall/goods/toUpdate.action?lang=pt&goodsId=${goodsId}">葡萄牙语</a></li>
			<li><a href="<%=basePath%>/mall/goods/toUpdate.action?lang=it&goodsId=${goodsId}">意大利语</a></li>
			<li><a href="<%=basePath%>/mall/goods/toUpdate.action?lang=ms&goodsId=${goodsId}">马来西亚语</a></li>
			<li><a href="<%=basePath%>/mall/goods/toUpdate.action?lang=af&goodsId=${goodsId}">南非荷兰语</a></li>
			<li><a href="<%=basePath%>/mall/goods/toUpdate.action?lang=el&goodsId=${goodsId}">希腊语</a></li>
			<li><a href="<%=basePath%>/mall/goods/toUpdate.action?lang=tw&goodsId=${goodsId}">中文繁体</a></li>
			<li><a href="<%=basePath%>/mall/goods/toUpdate.action?lang=cn&goodsId=${goodsId}">中文简体</a></li>
			<li><a href="<%=basePath%>/mall/goods/toUpdate.action?lang=tr&goodsId=${goodsId}">土耳其语</a></li>
			<li><a href="<%=basePath%>/mall/goods/toUpdate.action?lang=ja&goodsId=${goodsId}">日语</a></li>
			<li><a href="<%=basePath%>/mall/goods/toUpdate.action?lang=ko&goodsId=${goodsId}">韩语</a></li>
			<li><a href="<%=basePath%>/mall/goods/toUpdate.action?lang=th&goodsId=${goodsId}">泰语</a></li>
			<li><a href="<%=basePath%>/mall/goods/toUpdate.action?lang=ph&goodsId=${goodsId}">菲律宾语</a></li>
			<li><a href="<%=basePath%>/mall/goods/toUpdate.action?lang=ar&goodsId=${goodsId}">阿拉伯语</a></li>
		</ul>
		<h3>商品管理</h3>
