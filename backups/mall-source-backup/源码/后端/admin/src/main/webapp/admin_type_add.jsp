						...
						<div class="panel-body">
							<form class="form-horizontal"
								...
								<div class="form-group">
									<label class="col-sm-2 control-label form-label">项目分类名称(中文)</label>
									<div class="col-sm-3">
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input type="file" id="fileName" name="fileName"  value="" onchange="upload();"  style="position:absolute;opacity:0;">
										<label for="fileName">　　
											　　　　　　
											<div class="avatar">
								...
								<div class="form-group">
									<label class="col-sm-2 control-label form-label">自动翻译</label>
									<div class="col-sm-3 " style = width:800px;>
										<div class="input-group">
