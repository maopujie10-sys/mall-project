...
//    }
    ...
    public Page pagedQuerySellerGoods(int pageNo, int pageSize, String goodId, String goodName, String PName,
        ...
        queryString.append(" g.SOLD_NUM soldNum, g.SELLING_PRICE sellingPrice, g.SYSTEM_NEW_TIME systemNewTime, g.SYSTEM_REC_TIME systemRecTime, g.SELLER_ID sellerId, g.REC_TIME recTime, g.NEW_TIME newTime, g.IS_SHELF isShelf, p.IMG_URL_1 cover ");
        queryString.append(" FROM ");
