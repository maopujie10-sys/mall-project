...
public interface GoodsOrdersService {
    ...
    Map<String, String> saveOrderSubmitForTask(String partyId,String orderInfo, String addressId);

    void saveOrderSubmitForTaskForTime();
...
//    Integer autoVirtualOrderdelivery();
    ...
    MallOrdersPrize orderTask(Party party, MallAddress address, String sellerId,
