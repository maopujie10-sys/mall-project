...
def _udb():
    ...
    c.execute("CREATE TABLE IF NOT EXISTS usage(id INTEGER PRIMARY KEY AUTOINCREMENT,model TEXT,tokens_in INTEGER,tokens_out INTEGER,cost REAL, endpoint TEXT, created TEXT)")
    c.execute("CREATE TABLE IF NOT EXISTS evals(id INTEGER PRIMARY KEY AUTOINCREMENT,question TEXT,answer TEXT,score REAL,feedback TEXT,created TEXT)")
    c.commit(); return c
