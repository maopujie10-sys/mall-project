"""Master Agent 鈥?Friday AI OS 鎬绘帶澶ц剳
鑱岃矗锛氫换鍔℃媶瑙ｃ€丄gent璋冨害銆佷笂涓嬫枃绠＄悊銆侀暱鏈熺洰鏍囪拷韪?v2: Claude 鐪熷疄AI鎺ㄧ悊 + 鍏抽敭璇嶅厹搴?""
import json
import httpx
import time
...
class MasterAgent:
    ...
    async def _ai_analyze(message: str) -> Optional[dict]:
        ...
        prompt = f"""浣犳槸 Friday AI OS 鐨勬€绘帶澶ц剳銆傚垎鏋愮敤鎴锋秷鎭紝杩斿洖闇€瑕佽皟鐢ㄧ殑Agent鍒楄〃銆?
鍙敤Agent:
{agent_desc}

鐢ㄦ埛娑堟伅: {message}

杩斿洖绾疛SON锛堜笉瑕乵arkdown鍖呰９锛?
